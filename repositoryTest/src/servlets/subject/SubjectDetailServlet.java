...
public class SubjectDetailServlet extends HttpServlet {
	...
	protected void doGet(
		...
		try {
			...
			out.println("	<td style='text-align:left;'>" + subject.getNo() + "</td>");
			out.println("</tr>");

			out.println("<tr>");
			out.println("	<th>과목명</th>");
			out.println("	<td style='text-align:left;'>" + subject.getTitle() + "</td>");
			out.println("</tr>");

			out.println("<tr>");
			out.println("	<th>내용</th>");
			out.println("	<td style='text-align:left;'><textarea rows='5' cols='60'>" + subject.getDescription() + "</textarea></td>");
			out.println("</tr>");
			out.println("</table>");
			out.println("<a href='list.bit?pageNo=1&pageSize=10'>목록</a>");
			out.println("<a href='delete.bit?no=" + subject.getNo() + "'>삭제</a>");
			out.println("<a href='update.bit?no=" + subject.getNo() + "'>변경</a><br>");
		} catch (Throwable e) {
